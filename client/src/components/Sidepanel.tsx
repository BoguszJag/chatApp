  ...
  return (
    <div className='flex flex-col justfiy-normal items-start border-r border-solid border-black'>
        <div className='flex justify-normal items-start w-full'>
          <button className='w-full h-10' onClick={handleContactsView}>{switchView.viewAddContacts ? 'Contacts' : 'Add Contacts'}</button>
          <button className='w-full h-10' name='invitations' onClick={handleInvitationsView}>Invitations</button>  
        </div>
