...
function Search({handleInputChange, handleUsers, apiRoute}: props) {
  ...
  return (
    <input className='w-custom_margin min-h-10 px-5 mx-3 my-3 placholder-gray-400 bg-[#40444b] focus:outline-none rounded-xl' placeholder='Search for new contacts' onChange={(e) => handleChange(e)} type='text' value={input} name='users' />
  );
};
